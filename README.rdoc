...
<tt>dynamic portlet XML creation</tt>
<tt>portlet session security mechanism</tt>
<tt>Rails-portlet JAR install command</tt>
<tt>list of portlets during development</tt>
