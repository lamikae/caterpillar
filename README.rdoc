...
== Implementing File Download with Caterpillar

In order to use download links on your webpages, you need to use method send_file(filePath, :filename=>"fileName") , in which the parameter filePath represents the location of the file, and fileName represents the name of the file. 
...
In your webpage, you should use the following method which will manage your urls:
  liferay_resource_url(:controller=> :download, :action=> :start) 
